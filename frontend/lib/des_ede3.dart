...
class DesEde3 {
  static String encrypt(String plainText, String key) {
    List<int> encodeKey = utf8.encode(key).getRange(0, 16).toList();
    var cipher = DES3(key: encodeKey, mode: DESMode.ECB);
  ...
  static String decrypt(String cipherText, String key) {
    List<int> decodeKey = key.substring(0, 16).codeUnits;
    var cipher = DES3(key: decodeKey, mode: DESMode.ECB);
